...
export function WhatsAppFloat() {
  const message = encodeURIComponent("Hello! I am reaching out from Kalaimagal Matriculation School website to enquire about admissions.");
  const whatsappUrl = "https://wa.me/917010624186?text=" + message;
